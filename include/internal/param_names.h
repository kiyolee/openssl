...
#define PIDX_PKEY_PARAM_ML_DSA_INPUT_FORMATS 222
#define PIDX_PKEY_PARAM_ML_DSA_OUTPUT_FORMATS 223
#define PIDX_PKEY_PARAM_ML_DSA_PREFER_SEED 224
#define PIDX_PKEY_PARAM_ML_DSA_RETAIN_SEED 225
#define PIDX_PKEY_PARAM_ML_DSA_SEED 140
#define PIDX_PKEY_PARAM_ML_KEM_IMPORT_PCT_TYPE 226
#define PIDX_PKEY_PARAM_ML_KEM_INPUT_FORMATS 227
#define PIDX_PKEY_PARAM_ML_KEM_OUTPUT_FORMATS 228
#define PIDX_PKEY_PARAM_ML_KEM_PREFER_SEED 229
#define PIDX_PKEY_PARAM_ML_KEM_RETAIN_SEED 230
#define PIDX_PKEY_PARAM_ML_KEM_SEED 140
#define PIDX_PKEY_PARAM_PAD_MODE 231
#define PIDX_PKEY_PARAM_PRIV_KEY 232
#define PIDX_PKEY_PARAM_PROPERTIES PIDX_ALG_PARAM_PROPERTIES
#define PIDX_PKEY_PARAM_PUB_KEY 233
#define PIDX_PKEY_PARAM_RSA_BITS PIDX_PKEY_PARAM_BITS
#define PIDX_PKEY_PARAM_RSA_COEFFICIENT 234
#define PIDX_PKEY_PARAM_RSA_COEFFICIENT1 235
#define PIDX_PKEY_PARAM_RSA_COEFFICIENT2 236
#define PIDX_PKEY_PARAM_RSA_COEFFICIENT3 237
#define PIDX_PKEY_PARAM_RSA_COEFFICIENT4 238
#define PIDX_PKEY_PARAM_RSA_COEFFICIENT5 239
#define PIDX_PKEY_PARAM_RSA_COEFFICIENT6 240
#define PIDX_PKEY_PARAM_RSA_COEFFICIENT7 241
#define PIDX_PKEY_PARAM_RSA_COEFFICIENT8 242
#define PIDX_PKEY_PARAM_RSA_COEFFICIENT9 243
#define PIDX_PKEY_PARAM_RSA_D 244
#define PIDX_PKEY_PARAM_RSA_DERIVE_FROM_PQ 245
...
#define PIDX_PKEY_PARAM_RSA_E 246
#define PIDX_PKEY_PARAM_RSA_EXPONENT 247
#define PIDX_PKEY_PARAM_RSA_EXPONENT1 248
#define PIDX_PKEY_PARAM_RSA_EXPONENT10 249
#define PIDX_PKEY_PARAM_RSA_EXPONENT2 250
#define PIDX_PKEY_PARAM_RSA_EXPONENT3 251
#define PIDX_PKEY_PARAM_RSA_EXPONENT4 252
#define PIDX_PKEY_PARAM_RSA_EXPONENT5 253
#define PIDX_PKEY_PARAM_RSA_EXPONENT6 254
#define PIDX_PKEY_PARAM_RSA_EXPONENT7 255
#define PIDX_PKEY_PARAM_RSA_EXPONENT8 256
#define PIDX_PKEY_PARAM_RSA_EXPONENT9 257
#define PIDX_PKEY_PARAM_RSA_FACTOR 258
#define PIDX_PKEY_PARAM_RSA_FACTOR1 259
#define PIDX_PKEY_PARAM_RSA_FACTOR10 260
#define PIDX_PKEY_PARAM_RSA_FACTOR2 261
#define PIDX_PKEY_PARAM_RSA_FACTOR3 262
#define PIDX_PKEY_PARAM_RSA_FACTOR4 263
#define PIDX_PKEY_PARAM_RSA_FACTOR5 264
#define PIDX_PKEY_PARAM_RSA_FACTOR6 265
#define PIDX_PKEY_PARAM_RSA_FACTOR7 266
#define PIDX_PKEY_PARAM_RSA_FACTOR8 267
#define PIDX_PKEY_PARAM_RSA_FACTOR9 268
...
#define PIDX_PKEY_PARAM_RSA_PRIMES 269
#define PIDX_PKEY_PARAM_RSA_PSS_SALTLEN 270
#define PIDX_PKEY_PARAM_RSA_TEST_P1 271
#define PIDX_PKEY_PARAM_RSA_TEST_P2 272
#define PIDX_PKEY_PARAM_RSA_TEST_Q1 273
#define PIDX_PKEY_PARAM_RSA_TEST_Q2 274
#define PIDX_PKEY_PARAM_RSA_TEST_XP 275
#define PIDX_PKEY_PARAM_RSA_TEST_XP1 276
#define PIDX_PKEY_PARAM_RSA_TEST_XP2 277
#define PIDX_PKEY_PARAM_RSA_TEST_XQ 278
#define PIDX_PKEY_PARAM_RSA_TEST_XQ1 279
#define PIDX_PKEY_PARAM_RSA_TEST_XQ2 280
#define PIDX_PKEY_PARAM_SECURITY_BITS 281
#define PIDX_PKEY_PARAM_SLH_DSA_SEED 140
#define PIDX_PKEY_PARAM_USE_COFACTOR_ECDH PIDX_PKEY_PARAM_USE_COFACTOR_FLAG
#define PIDX_PKEY_PARAM_USE_COFACTOR_FLAG 282
#define PIDX_PROV_PARAM_BUILDINFO 283
#define PIDX_PROV_PARAM_CORE_MODULE_FILENAME 284
#define PIDX_PROV_PARAM_CORE_PROV_NAME 285
#define PIDX_PROV_PARAM_CORE_VERSION 286
#define PIDX_PROV_PARAM_DRBG_TRUNC_DIGEST 287
#define PIDX_PROV_PARAM_DSA_SIGN_DISABLED 288
#define PIDX_PROV_PARAM_ECDH_COFACTOR_CHECK 289
#define PIDX_PROV_PARAM_HKDF_DIGEST_CHECK 290
#define PIDX_PROV_PARAM_HKDF_KEY_CHECK 291
#define PIDX_PROV_PARAM_HMAC_KEY_CHECK 292
#define PIDX_PROV_PARAM_KBKDF_KEY_CHECK 293
#define PIDX_PROV_PARAM_KMAC_KEY_CHECK 294
#define PIDX_PROV_PARAM_NAME 295
#define PIDX_PROV_PARAM_NO_SHORT_MAC 296
#define PIDX_PROV_PARAM_PBKDF2_LOWER_BOUND_CHECK 297
#define PIDX_PROV_PARAM_RSA_PKCS15_PAD_DISABLED 298
#define PIDX_PROV_PARAM_RSA_PSS_SALTLEN_CHECK 299
#define PIDX_PROV_PARAM_RSA_SIGN_X931_PAD_DISABLED 300
#define PIDX_PROV_PARAM_SECURITY_CHECKS 301
#define PIDX_PROV_PARAM_SELF_TEST_DESC 302
#define PIDX_PROV_PARAM_SELF_TEST_PHASE 303
#define PIDX_PROV_PARAM_SELF_TEST_TYPE 304
#define PIDX_PROV_PARAM_SIGNATURE_DIGEST_CHECK 305
#define PIDX_PROV_PARAM_SSHKDF_DIGEST_CHECK 306
#define PIDX_PROV_PARAM_SSHKDF_KEY_CHECK 307
#define PIDX_PROV_PARAM_SSKDF_DIGEST_CHECK 308
#define PIDX_PROV_PARAM_SSKDF_KEY_CHECK 309
#define PIDX_PROV_PARAM_STATUS 310
#define PIDX_PROV_PARAM_TDES_ENCRYPT_DISABLED 311
#define PIDX_PROV_PARAM_TLS13_KDF_DIGEST_CHECK 312
#define PIDX_PROV_PARAM_TLS13_KDF_KEY_CHECK 313
#define PIDX_PROV_PARAM_TLS1_PRF_DIGEST_CHECK 314
#define PIDX_PROV_PARAM_TLS1_PRF_EMS_CHECK 315
#define PIDX_PROV_PARAM_TLS1_PRF_KEY_CHECK 316
#define PIDX_PROV_PARAM_VERSION 115
#define PIDX_PROV_PARAM_X942KDF_KEY_CHECK 317
#define PIDX_PROV_PARAM_X963KDF_DIGEST_CHECK 318
#define PIDX_PROV_PARAM_X963KDF_KEY_CHECK 319
#define PIDX_RAND_PARAM_FIPS_APPROVED_INDICATOR PIDX_ALG_PARAM_FIPS_APPROVED_INDICATOR
#define PIDX_RAND_PARAM_GENERATE 320
#define PIDX_RAND_PARAM_MAX_REQUEST 321
#define PIDX_RAND_PARAM_STATE 322
#define PIDX_RAND_PARAM_STRENGTH 323
#define PIDX_RAND_PARAM_TEST_ENTROPY 324
#define PIDX_RAND_PARAM_TEST_NONCE 325
#define PIDX_SIGNATURE_PARAM_ADD_RANDOM 326
...
#define PIDX_SIGNATURE_PARAM_CONTEXT_STRING 327
#define PIDX_SIGNATURE_PARAM_DETERMINISTIC 328
...
#define PIDX_SIGNATURE_PARAM_FIPS_RSA_PSS_SALTLEN_CHECK 299
#define PIDX_SIGNATURE_PARAM_FIPS_SIGN_CHECK PIDX_PKEY_PARAM_FIPS_SIGN_CHECK
#define PIDX_SIGNATURE_PARAM_FIPS_SIGN_X931_PAD_CHECK 329
#define PIDX_SIGNATURE_PARAM_FIPS_VERIFY_MESSAGE 330
#define PIDX_SIGNATURE_PARAM_INSTANCE 331
#define PIDX_SIGNATURE_PARAM_KAT 332
#define PIDX_SIGNATURE_PARAM_MESSAGE_ENCODING 333
...
#define PIDX_SIGNATURE_PARAM_MU 334
#define PIDX_SIGNATURE_PARAM_NONCE_TYPE 335
...
#define PIDX_SIGNATURE_PARAM_PSS_SALTLEN 270
#define PIDX_SIGNATURE_PARAM_SIGNATURE 336
#define PIDX_SIGNATURE_PARAM_TEST_ENTROPY 337
#define PIDX_SKEY_PARAM_KEY_LENGTH 338
#define PIDX_SKEY_PARAM_RAW_BYTES 339
#define PIDX_STORE_PARAM_ALIAS 340
#define PIDX_STORE_PARAM_DIGEST 3
#define PIDX_STORE_PARAM_EXPECT 341
#define PIDX_STORE_PARAM_FINGERPRINT 342
#define PIDX_STORE_PARAM_INPUT_TYPE 343
#define PIDX_STORE_PARAM_ISSUER 295

 ...
 */
/*
 * Generated from cipher_aes_wrp.c.in for https://github.com/kiyolee/openssl.git.
 */
...
#ifndef aes_wrap_set_ctx_params_list
static const OSSL_PARAM aes_wrap_set_ctx_params_list[] = {
    OSSL_PARAM_size_t(OSSL_CIPHER_PARAM_KEYLEN, NULL),
    OSSL_PARAM_END
};
#endif

#ifndef aes_wrap_set_ctx_params_st
struct aes_wrap_set_ctx_params_st {
    OSSL_PARAM *keylen;
};
#endif

#ifndef aes_wrap_set_ctx_params_decoder
static int aes_wrap_set_ctx_params_decoder
    (const OSSL_PARAM *p, struct aes_wrap_set_ctx_params_st *r)
{
    const char *s;

 ...
 */
/*
 * Generated from cipher_aes_gcm_siv.c.in for https://github.com/kiyolee/openssl.git.
 */
...
#ifndef ossl_aes_gcm_siv_get_ctx_params_list
static const OSSL_PARAM ossl_aes_gcm_siv_get_ctx_params_list[] = {
...
#ifndef ossl_aes_gcm_siv_get_ctx_params_st
struct ossl_aes_gcm_siv_get_ctx_params_st {
    OSSL_PARAM *keylen;
    OSSL_PARAM *tag;
    OSSL_PARAM *taglen;
};
...
static int ossl_aes_gcm_siv_get_ctx_params_decoder
    (const OSSL_PARAM *p, struct ossl_aes_gcm_siv_get_ctx_params_st *r)
{
    const char *s;
...
/* Machine generated by util/perl/OpenSSL/paramnames.pm */
#ifndef aes_gcm_siv_set_ctx_params_list
static const OSSL_PARAM aes_gcm_siv_set_ctx_params_list[] = {
    OSSL_PARAM_size_t(OSSL_CIPHER_PARAM_KEYLEN, NULL),
...
#ifndef aes_gcm_siv_set_ctx_params_st
struct aes_gcm_siv_set_ctx_params_st {
    OSSL_PARAM *keylen;
    OSSL_PARAM *speed;
    OSSL_PARAM *tag;
};
...
#ifndef aes_gcm_siv_set_ctx_params_decoder
static int aes_gcm_siv_set_ctx_params_decoder
    (const OSSL_PARAM *p, struct aes_gcm_siv_set_ctx_params_st *r)
{
    const char *s;

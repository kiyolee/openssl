 ...
 */
/*
 * Generated from x942kdf.c.in for https://github.com/kiyolee/openssl.git.
 */
        ...
        for (; (s = p->key) != NULL; p++)
            ...
            case 'a':
                if (ossl_likely(strcmp("cvp-info", s + 1) == 0)) {
                    if (ossl_likely(r->acvp == NULL))
                        r->acvp = (OSSL_PARAM *)p;
                }
                break;
            case 'c':
                if (ossl_likely(strcmp("ekalg", s + 1) == 0)) {
                    if (ossl_likely(r->cekalg == NULL))
                            ...
                            case 'y':
                                ...
                                case 'u':
                                    if (ossl_likely(strcmp("-info", s + 6) == 0)) {
                                        if (ossl_likely(r->uinfo == NULL))
                                            r->uinfo = (OSSL_PARAM *)p;
                                    }
                                    break;
                                case 'v':
                                    if (ossl_likely(strcmp("-info", s + 6) == 0)) {
                                        if (ossl_likely(r->vinfo == NULL))

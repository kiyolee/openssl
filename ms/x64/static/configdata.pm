...
our %config = (
  ...
  perl_version => "5.32.1",
  perlargv => [ "--prefix=C:\\Program Files\\OpenSSL-1_1", "--with-zlib-include=..\\zlib", "--with-zlib-lib=..\\zlib\\build\\x64\\Release\\libz-static.lib", "VC-WIN64A-masm", "no-shared", "no-dynamic-engine", "zlib", "enable-quic-boring" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
...
our %target = (
  ...
  defines => [ "ZLIB", "OPENSSL_SYS_WIN32", "WIN32_LEAN_AND_MEAN", "UNICODE", "_UNICODE", "_CRT_SECURE_NO_DEPRECATE", "_WINSOCK_DEPRECATED_NO_WARNINGS" ],
  ...
  enable => [  ],
  ex_libs => "..\\zlib\\build\\x64\\Release\\libz-static.lib ws2_32.lib gdi32.lib advapi32.lib crypt32.lib user32.lib",
  exe_extension => "",
  includes => [ "..\\zlib" ],
...
our %withargs = (
  zlib_include => "..\\zlib",
  zlib_lib => "..\\zlib\\build\\x64\\Release\\libz-static.lib",
);

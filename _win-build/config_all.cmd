...
set OPENSSL_VER=3.2.0-dev
set OPENSSL_VER_SED=3\.2\.0-dev
...
>configdata.pm sed -e "s/%OPENSSL_DIR_SED%/\./g" -e "s/\(['\"]\)[A-Za-z]:[^^'\"]*\/%OPENSSL_BASE_SED%\(['\"\/]\)/\1\.\2/" -e "s/\"RANLIB\" =^> \"CODE(0x[0-9a-f]\+)\"/\"RANLIB\" =^> \"CODE(0xf1e2d3c4)\"/" configdata.pm.org
dos2unix %_GEN_LIST%
exit /b

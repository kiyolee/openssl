...
static const ERR_STRING_DATA SSL_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_QUIC_BORING_BAD_DATA_LENGTH), "quic boring bad data length"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_QUIC_BORING_INTERNAL_ERROR), "quic boring internal error"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_QUIC_BORING_WRONG_ENCRYPTION_LEVEL_RECEIVED),
    "quic boring wrong encryption level received"},

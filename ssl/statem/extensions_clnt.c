...
/* SAME AS tls_construct_stoc_quic_boring_transport_params_draft() */
EXT_RETURN tls_construct_ctos_quic_boring_transport_params_draft(SSL_CONNECTION *s, WPACKET *pkt,
                                                                 unsigned int context,
                                                                 X509 *x,
                                                                 size_t chainidx)
{
    if (s->ext.quic_boring_transport_params == NULL
...
#ifndef OPENSSL_NO_QUIC_BORING
/* SAME AS tls_parse_ctos_quic_boring_transport_params_draft() */

...
static int init_quic_boring_transport_params(SSL_CONNECTION *s, unsigned int context);
static int final_quic_boring_transport_params_draft(SSL_CONNECTION *s, unsigned int context,
                                                    int sent);
static int final_quic_boring_transport_params_v1(SSL_CONNECTION *s, unsigned int context,
                                                 int sent);
#endif
...
#ifndef OPENSSL_NO_QUIC_BORING
    {
        TLSEXT_TYPE_quic_boring_transport_parameters_draft,
        SSL_EXT_CLIENT_HELLO | SSL_EXT_TLS1_3_ENCRYPTED_EXTENSIONS
        | SSL_EXT_TLS_IMPLEMENTATION_ONLY | SSL_EXT_TLS1_3_ONLY,
        init_quic_boring_transport_params,
        tls_parse_ctos_quic_boring_transport_params_draft, tls_parse_stoc_quic_boring_transport_params_draft,
        tls_construct_stoc_quic_boring_transport_params_draft, tls_construct_ctos_quic_boring_transport_params_draft,
        final_quic_boring_transport_params_draft,
    },
    {
        TLSEXT_TYPE_quic_boring_transport_parameters_v1,
        SSL_EXT_CLIENT_HELLO | SSL_EXT_TLS1_3_ENCRYPTED_EXTENSIONS
        | SSL_EXT_TLS_IMPLEMENTATION_ONLY | SSL_EXT_TLS1_3_ONLY,
        init_quic_boring_transport_params,
        tls_parse_ctos_quic_boring_transport_params_v1, tls_parse_stoc_quic_boring_transport_params_v1,
        tls_construct_stoc_quic_boring_transport_params_v1, tls_construct_ctos_quic_boring_transport_params_v1,
        final_quic_boring_transport_params_v1,
    },
#else
    INVALID_EXTENSION,
    INVALID_EXTENSION,
                                                 ...
                                                 int sent)
{
    ...
    if (s->ext.peer_quic_boring_transport_params_draft_len == 0
        && s->ext.peer_quic_boring_transport_params_v1_len == 0) {
        SSLfatal(s, SSL_AD_MISSING_EXTENSION,
                 SSL_R_QUIC_BORING_MISSING_TRANSPORT_PARAMETERS_EXTENSION);
        return 0;
    }
